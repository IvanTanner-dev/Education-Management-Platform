              ...
              >
                <div className="p-3 flex flex-col gap-2">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span
                      className={`px-2 py-1 rounded-full text-[10px] font-black uppercase tracking-tighter flex-shrink-0 ${
                        userRole === "admin"
                          ? "bg-purple-100 text-purple-700"
                          : userRole === "teacher"
                            ? "bg-blue-100 text-blue-700"
                  ...
                  <div className="flex gap-2 justify-end mt-1">
                    <button
                      onClick={() => handleOpenEditModal(user)}
                      className="flex-1 py-2 bg-slate-50 hover:bg-slate-100 text-slate-600 rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-1"
                    >
                      <span>✎</span>
                      <span>Edit</span>
                    </button>
                    <button
                      onClick={() => handleRemoveUser(user.id)}
                      className="flex-1 py-2 bg-red-50 hover:bg-red-100 text-red-600 rounded-xl text-sm font-bold transition-all flex items-center justify-center gap-1"
                    >
                      <span>✕</span>
                      <span>Remove</span>
                    </button>
